...
def fill_map(map, data_arr)
  (1..2022 - 2005).each.with_index(2005) do |index, year|
...
minimum_wage_for_years_tl = [350, 380, 403, 481, 527, 576, 629, 701, 773, 846, 949, 1300, 1404, 1603, 2020, 2324, 2825]
minimum_wage_map = {}

fill_map(minimum_wage_map, minimum_wage_for_years_tl)

tl_dollar_rate_for_years = [1.34, 1.43, 1.30, 1.29, 1.54, 1.50, 1.67, 1.79, 1.90, 2.18, 2.72, 3.02, 3.64, 4.81, 5.67, 7.01,
                            8.91]
tl_dollar_rate_map = {}
